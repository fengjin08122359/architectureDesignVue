...
var build$1 = /*@__PURE__*/unwrapExports(build);
...
__decorate([
    Prop()
], InstanceSlot.prototype, "needRender", void 0);
InstanceSlot = __decorate([
    Component({ template: `<div class="mergeRender"> <InstanceSlot :instance="target"></InstanceSlot> <el-input type='textarea' :value="staticTemplate" ></el-input> <InstanceSlot :instance="target" :needRender='true'></InstanceSlot> <el-input type='textarea' v-model="target.view"></el-input> <div v-for="(error, index) in errors" :key="index"> <el-input type='textarea' :value="error"></el-input> </div> </div>` })
], InstanceSlot);
let MergeRender = class MergeRender extends Vue {
    constructor() {
        super(...arguments);
        this.target = new CompMergeInstance();
        this.staticTemplate = '';
    }
    get errors() {
        var res = build$1.compile(this.target.instance.renderTemplate);
        return res.errors;
    }
    mounted() {
...
__decorate([
    Watch('target.view')
], MergeRender.prototype, "onWatchIV", null);
MergeRender = __decorate([
    Component({ components: { InstanceSlot } })
], MergeRender);
var MergeRender$1 = MergeRender;

let App = class App extends Vue {
};
App = __decorate([
    Component({ components: { MergeRender: MergeRender$1 } })
], App);
var App$1 = App;
