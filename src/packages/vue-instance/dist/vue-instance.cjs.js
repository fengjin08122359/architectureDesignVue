...
const errorCode = new instance.ErrorCode();
const keyFrame = new instance.EventDispatcher();
const httpIntercept = new instance.Intercept();
const wsIntercept = new instance.Intercept();
const routerIntercept = new instance.Intercept();
